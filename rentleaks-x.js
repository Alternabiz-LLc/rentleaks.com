...
(function () {
  ...
  var SRC = {
    fare: { label: 'NYC FARE Act, Local Law 119 of 2024', eff: '2025-06-11', url: 'https://www.nyc.gov/site/dca/news/018-25/dcwp-the-fare-act-now-effect' },
    ...
    coHb1090: { label: 'Colorado HB25-1090 price transparency, C.R.S. § 6-1-737', eff: '2026-01-01', url: 'https://leg.colorado.gov/bills/hb25-1090' },
    mnTotal: { label: 'Minnesota "Total Monthly Payment" disclosure', eff: '2024-01-01', url: 'https://winthrop.com/bold-perspectives/minnesotas-revamped-landlord-tenant-laws-top-10-things-all-residential-landlords-should-know/' },
    seattleCrim: { label: 'Seattle Fair Chance Housing Ordinance', eff: '2017-08-01', url: 'https://www.seattle.gov/civilrights/housing-rights/criminal-history-protections' },
    ftcFees: { label: 'FTC Rule on Unfair or Deceptive Fees, 16 CFR Part 464', eff: '2025-05-12', url: 'https://www.ftc.gov/business-guidance/resources/rule-unfair-or-deceptive-fees-frequently-asked-questions' },
    fha: { label: 'Fair Housing Act advertising rules, 24 CFR § 100.75', eff: '1989-01-23', url: 'https://www.ecfr.gov/current/title-24/subtitle-B/chapter-I/part-100/subpart-B/section-100.75' },
    fcra: { label: 'FCRA — using consumer reports for tenant screening', eff: '1971-04-25', url: 'https://www.ftc.gov/business-guidance/resources/using-consumer-reports-what-landlords-need-know' },
    euStr: { label: 'Regulation (EU) 2024/1028 — short-term rental data sharing', eff: '2026-05-20', url: 'https://eur-lex.europa.eu/eli/reg/2024/1028/oj/eng' },
    dsa: { label: 'EU Digital Services Act, Arts. 16–18 notice and action', eff: '2024-02-17', url: 'https://www.cms-digitallaws.com/en/dsa/article-19/' },
    esReg: { label: 'Spain Real Decreto 1312/2024 — Registro Único de Arrendamientos', eff: '2025-07-01', url: 'https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-26931' },
    catSeason: { label: 'Catalonia Llei 11/2025 — seasonal and room rentals', eff: '2026-01-01', url: 'https://www.cuatrecasas.com/en/spain/real-estate/art/catalonia-regulates-seasonal-rentals' },
    itCin: { label: 'Italy CIN — Codice Identificativo Nazionale', eff: '2024-09-02', url: 'https://fiscomania.com/cin-affitti-brevi/' },
    deZweck: { label: 'Berlin Zweckentfremdungsverbot', eff: '2014-05-01', url: 'https://www.berlin.de/sen/wohnen/rechtliches/zweckentfremdungsverbot/' },
    frMobilite: { label: 'France bail mobilité (loi ELAN)', eff: '2018-11-24', url: 'https://www.lodgis.com/en/owners/helpful-hints/bail-mobilite-the-new-contract-for-furnished-rentals/' },
    nlGoed: { label: 'Netherlands Wet goed verhuurderschap', eff: '2023-07-01', url: 'https://en.straatmankoster.nl/actueel/wet-goed-verhuurderschap' },
    nlFixed: { label: 'Netherlands Fixed Lease Contracts Act', eff: '2024-07-01', url: 'https://cms.law/en/nld/publication/the-fixed-lease-contracts-act-first-experiences-from-the-field' },
    ukRra: { label: 'UK Renters’ Rights Act 2025', eff: '2026-05-01', url: 'https://www.legislation.gov.uk/ukpga/2025/26/contents' },
    toronto: { label: 'Toronto short-term rental by-law — 28-day threshold', eff: '2019-09-10', url: 'https://www.keycafe.com/s/blog/understanding-torontos-short-term-rental-regulations' },
    vancouver: { label: 'BC / Vancouver short-term rental rules — 30-day threshold', eff: '2024-05-01', url: 'https://liv.rent/blog/landlords/vancouver-short-term-rental-rules/' },
    montreal: { label: 'Québec tourist accommodation — 31-day threshold', eff: '2023-09-01', url: 'https://lendcity.ca/blog/short-term-rental-regulations-across-canada-city-by-city-guide/' },
  ...
  var RULES = {
    ...
    city: {
      'new-york': {
        ...
        reusableReport: true, reusableSrc: SRC.rpl238a,
      ...
      seattle:  { fairChance: true, fairChanceSrc: SRC.seattleCrim, soiProtected: true, soiSrc: SRC.seattleCrim },
      chicago:  { fairChance: true, fairChanceSrc: SRC.fcha, soiProtected: true },
      denver:   { allInDisclosure: true, allInSrc: SRC.coHb1090, soiProtected: true },
      portland: { fairChance: true, soiProtected: true },
      boston:   { soiProtected: true, allInDisclosure: true, allInSrc: SRC.ftcFees },
      'washington-dc': { soiProtected: true, fairChance: true },
      barcelona: {
        registrationRequired: true, registrationSrc: SRC.catSeason,
        contractType: 'Contracte de temporada — the temporary purpose must be documented in the contract',
        notes: ['Catalonia’s seasonal and room-rental regime reaches mid-term lets, not only tourist lets. Rent caps can apply.']
      },
      berlin: {
        minStayDays: 90, minStaySrc: SRC.deZweck,
        registrationRequired: true, registrationSrc: SRC.deZweck,
        contractType: 'Zeitmietvertrag with a documented temporary purpose',
        notes: ['Berlin’s misappropriation ban is the binding constraint, and the practical threshold sits near three months rather than 30 days.']
      },
      paris: {
        contractType: 'Bail mobilité — 1 to 10 months, non-renewable, no deposit permitted',
        depositCapMonths: 0, depositSrc: SRC.frMobilite,
        notes: ['The bail mobilité is only available to tenants in training, study, apprenticeship, professional assignment or temporary posting. Eligibility must be captured at application.']
      },
      amsterdam: {
        minStayDays: 30,
      ...
      vancouver: { minStayDays: 30, minStaySrc: SRC.vancouver },
      montreal:  { minStayDays: 31, minStaySrc: SRC.montreal },
      'quebec-city': { minStayDays: 31, minStaySrc: SRC.montreal },
      london: {
        contractType: 'Assured tenancy, periodic — fixed terms abolished',
        allInDisclosure: true, allInSrc: SRC.ukRra,
        notes: ['The advertised rent is a ceiling: accepting more than the stated rent is prohibited, and no more than one month’s rent may be taken in advance.']
      }
    },
    ...
    region: {
      ...
      WA: { fairChance: true, fairChanceSrc: SRC.seattleCrim, soiProtected: true },
      OR: { fairChance: true, soiProtected: true },
      NJ: { fairChance: true, soiProtected: true },
      CA: { soiProtected: true, allInDisclosure: true, allInSrc: SRC.ftcFees },
      CT: { allInDisclosure: true, allInSrc: SRC.ftcFees, soiProtected: true },
      VA: { allInDisclosure: true, allInSrc: SRC.ftcFees },
      DC: { soiProtected: true, fairChance: true },
      England: { contractType: 'Assured tenancy, periodic', allInDisclosure: true, allInSrc: SRC.ukRra },
      Scotland: { contractType: 'Private residential tenancy' },
      ON: { minStayDays: 28, minStaySrc: SRC.toronto },
      BC: { minStayDays: 30, minStaySrc: SRC.vancouver },
      QC: { minStayDays: 31, minStaySrc: SRC.montreal }
    },

    /* ---------------- country level ---------------- */
    country: {
      US: { minStayDays: 30, allInDisclosure: true, allInSrc: SRC.ftcFees, screeningLaw: SRC.fcra, adLaw: SRC.fha },
      CA: { minStayDays: 30, adLaw: SRC.fha },
      GB: { minStayDays: 30, contractType: 'Assured tenancy, periodic', allInDisclosure: true, allInSrc: SRC.ukRra },
  ...
  var BANNED = [
    // Familial status
    'no kids', 'no children', 'adults only', 'no families', 'child free', 'childfree', 'mature person only',
    // Disability
    'no wheelchair', 'able bodied', 'able-bodied', 'no disabilities', 'not suitable for disabled', 'no service animals',
    // National origin, race, religion
    'no foreigners', 'americans only', 'english speakers only', 'christian only', 'christians only', 'muslim only', 'no muslims', 'jewish only', 'whites only', 'no immigrants',
    // Source of income
    'no vouchers', 'no section 8', 'no section8', 'no dss', 'no housing benefit', 'no cityfheps', 'working professionals only', 'employed only',
