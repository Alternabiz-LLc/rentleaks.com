  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        live: "Network live",
        badge: "network",
        keywords: "broker network referral partner agent tenant representation hire a broker fee agreement e-sign signature commission lead magnet guide download headshot roster playbook partner kit",
      },
    ],
  },
  {
...
export const DESK_ACTIONS: Array<{ href: string; label: string; hint: string; icon: DeskIcon; key: AccessKey | "any" }> = [
  ...
  { href: "/admin/referrals?tab=guides", label: "Guide downloads to follow up", hint: "Broker network", icon: "mail", key: "network" },
