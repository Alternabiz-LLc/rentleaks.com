  ...
  return (
    <fieldset className="adm-fieldset">
      ...
      <div className="adm-checks">
        <span className="a-dim">Kinds (none = all):</span>
        {CONTACT_KINDS.map((k) => (
      ...
      <div className="adm-checks">
        <span className="a-dim">Stages (none = all):</span>
      ...
      <div className="adm-row">
        <label>Any of these tags<input name="tags" defaultValue={a.tags?.join(", ")} placeholder="newsletter, brooklyn" /></label>
        <label>
          City
      ...
      <small className="a-dim">
        Unsubscribed and suppressed addresses are always excluded. Untick the opt-in box only for business outreach
        (hosts, operators, partners) — every email still carries an unsubscribe link and your mailing address.
      </small>
    </fieldset>
  );
}
